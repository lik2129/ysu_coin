...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {MERGE_OPERATION_TOTAL_TIME, "rocksdb.merge.operation.time.ysus"},
    {FILTER_OPERATION_TOTAL_TIME, "rocksdb.filter.operation.time.ysus"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {COMPRESSION_TIMES_YSUS, "rocksdb.compression.times.ysus"},
    {DECOMPRESSION_TIMES_YSUS, "rocksdb.decompression.times.ysus"},
