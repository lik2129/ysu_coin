...
PerfContext::PerfContext(const PerfContext& other) {
  ...
  write_thread_wait_ysus = other.write_thread_wait_ysus;
  write_scheduling_flushes_compactions_time =
      other.write_scheduling_flushes_compactions_time;
  db_mutex_lock_ysus = other.db_mutex_lock_ysus;
  db_condition_wait_ysus = other.db_condition_wait_ysus;
  merge_operator_time_ysus = other.merge_operator_time_ysus;
  read_index_block_ysus = other.read_index_block_ysus;
  read_filter_block_ysus = other.read_filter_block_ysus;
  new_table_block_iter_ysus = other.new_table_block_iter_ysus;
  new_table_iterator_ysus = other.new_table_iterator_ysus;
  block_seek_ysus = other.block_seek_ysus;
  find_table_ysus = other.find_table_ysus;
  ...
  env_new_sequential_file_ysus = other.env_new_sequential_file_ysus;
  env_new_random_access_file_ysus = other.env_new_random_access_file_ysus;
  env_new_writable_file_ysus = other.env_new_writable_file_ysus;
  env_reuse_writable_file_ysus = other.env_reuse_writable_file_ysus;
  env_new_random_rw_file_ysus = other.env_new_random_rw_file_ysus;
  env_new_directory_ysus = other.env_new_directory_ysus;
  env_file_exists_ysus = other.env_file_exists_ysus;
  env_get_children_ysus = other.env_get_children_ysus;
  env_get_children_file_attributes_ysus =
      other.env_get_children_file_attributes_ysus;
  env_delete_file_ysus = other.env_delete_file_ysus;
  env_create_dir_ysus = other.env_create_dir_ysus;
  env_create_dir_if_missing_ysus = other.env_create_dir_if_missing_ysus;
  env_delete_dir_ysus = other.env_delete_dir_ysus;
  env_get_file_size_ysus = other.env_get_file_size_ysus;
  env_get_file_modification_time_ysus =
      other.env_get_file_modification_time_ysus;
  env_rename_file_ysus = other.env_rename_file_ysus;
  env_link_file_ysus = other.env_link_file_ysus;
  env_lock_file_ysus = other.env_lock_file_ysus;
  env_unlock_file_ysus = other.env_unlock_file_ysus;
  env_new_logger_ysus = other.env_new_logger_ysus;
  get_cpu_ysus = other.get_cpu_ysus;
  iter_next_cpu_ysus = other.iter_next_cpu_ysus;
  iter_prev_cpu_ysus = other.iter_prev_cpu_ysus;
  iter_seek_cpu_ysus = other.iter_seek_cpu_ysus;
...
void PerfContext::Reset() {
  ...
  write_delay_time = 0;
  write_thread_wait_ysus = 0;
  write_scheduling_flushes_compactions_time = 0;
  db_mutex_lock_ysus = 0;
  db_condition_wait_ysus = 0;
  merge_operator_time_ysus = 0;
  read_index_block_ysus = 0;
  read_filter_block_ysus = 0;
  new_table_block_iter_ysus = 0;
  new_table_iterator_ysus = 0;
  block_seek_ysus = 0;
  find_table_ysus = 0;
  ...
  env_new_sequential_file_ysus = 0;
  env_new_random_access_file_ysus = 0;
  env_new_writable_file_ysus = 0;
  env_reuse_writable_file_ysus = 0;
  env_new_random_rw_file_ysus = 0;
  env_new_directory_ysus = 0;
  env_file_exists_ysus = 0;
  env_get_children_ysus = 0;
  env_get_children_file_attributes_ysus = 0;
  env_delete_file_ysus = 0;
  env_create_dir_ysus = 0;
  env_create_dir_if_missing_ysus = 0;
  env_delete_dir_ysus = 0;
  env_get_file_size_ysus = 0;
  env_get_file_modification_time_ysus = 0;
  env_rename_file_ysus = 0;
  env_link_file_ysus = 0;
  env_lock_file_ysus = 0;
  env_unlock_file_ysus = 0;
  env_new_logger_ysus = 0;
  get_cpu_ysus = 0;
  iter_next_cpu_ysus = 0;
  iter_prev_cpu_ysus = 0;
  iter_seek_cpu_ysus = 0;
...
std::string PerfContext::ToString(bool exclude_zero_counters) const {
  ...
  PERF_CONTEXT_OUTPUT(write_thread_wait_ysus);
  PERF_CONTEXT_OUTPUT(write_scheduling_flushes_compactions_time);
  PERF_CONTEXT_OUTPUT(db_mutex_lock_ysus);
  PERF_CONTEXT_OUTPUT(db_condition_wait_ysus);
  PERF_CONTEXT_OUTPUT(merge_operator_time_ysus);
  PERF_CONTEXT_OUTPUT(write_delay_time);
  PERF_CONTEXT_OUTPUT(read_index_block_ysus);
  PERF_CONTEXT_OUTPUT(read_filter_block_ysus);
  PERF_CONTEXT_OUTPUT(new_table_block_iter_ysus);
  PERF_CONTEXT_OUTPUT(new_table_iterator_ysus);
  PERF_CONTEXT_OUTPUT(block_seek_ysus);
  PERF_CONTEXT_OUTPUT(find_table_ysus);
  ...
  PERF_CONTEXT_OUTPUT(env_new_sequential_file_ysus);
  PERF_CONTEXT_OUTPUT(env_new_random_access_file_ysus);
  PERF_CONTEXT_OUTPUT(env_new_writable_file_ysus);
  PERF_CONTEXT_OUTPUT(env_reuse_writable_file_ysus);
  PERF_CONTEXT_OUTPUT(env_new_random_rw_file_ysus);
  PERF_CONTEXT_OUTPUT(env_new_directory_ysus);
  PERF_CONTEXT_OUTPUT(env_file_exists_ysus);
  PERF_CONTEXT_OUTPUT(env_get_children_ysus);
  PERF_CONTEXT_OUTPUT(env_get_children_file_attributes_ysus);
  PERF_CONTEXT_OUTPUT(env_delete_file_ysus);
  PERF_CONTEXT_OUTPUT(env_create_dir_ysus);
  PERF_CONTEXT_OUTPUT(env_create_dir_if_missing_ysus);
  PERF_CONTEXT_OUTPUT(env_delete_dir_ysus);
  PERF_CONTEXT_OUTPUT(env_get_file_size_ysus);
  PERF_CONTEXT_OUTPUT(env_get_file_modification_time_ysus);
  PERF_CONTEXT_OUTPUT(env_rename_file_ysus);
  PERF_CONTEXT_OUTPUT(env_link_file_ysus);
  PERF_CONTEXT_OUTPUT(env_lock_file_ysus);
  PERF_CONTEXT_OUTPUT(env_unlock_file_ysus);
  PERF_CONTEXT_OUTPUT(env_new_logger_ysus);
  PERF_CONTEXT_OUTPUT(get_cpu_ysus);
  PERF_CONTEXT_OUTPUT(iter_next_cpu_ysus);
  PERF_CONTEXT_OUTPUT(iter_prev_cpu_ysus);
  PERF_CONTEXT_OUTPUT(iter_seek_cpu_ysus);
