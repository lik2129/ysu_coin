...
void CompactionJobStats::Reset() {
  ...
  file_write_ysus = 0;
  file_range_sync_ysus = 0;
  file_fsync_ysus = 0;
  file_prepare_write_ysus = 0;
...
void CompactionJobStats::Add(const CompactionJobStats& stats) {
  ...
  file_write_ysus += stats.file_write_ysus;
  file_range_sync_ysus += stats.file_range_sync_ysus;
  file_fsync_ysus += stats.file_fsync_ysus;
  file_prepare_write_ysus += stats.file_prepare_write_ysus;
