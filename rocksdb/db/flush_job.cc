...
Status FlushJob::WriteLevel0Table() {
  ...
  const uint64_t start_cpu_micros = db_options_.env->NowCPUYsus() / 1000;
  Status s;
  {
  ...
  stats.cpu_micros = db_options_.env->NowCPUYsus() / 1000 - start_cpu_micros;
