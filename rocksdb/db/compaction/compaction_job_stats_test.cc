 ...
 public:
  ...
  void OnCompactionCompleted(DB* /*db*/, const CompactionJobInfo& ci) override {
    if (verify_next_comp_io_stats_) {
      ASSERT_GT(ci.stats.file_write_ysus, 0);
      ASSERT_GT(ci.stats.file_range_sync_ysus, 0);
      ASSERT_GT(ci.stats.file_fsync_ysus, 0);
      ASSERT_GT(ci.stats.file_prepare_write_ysus, 0);
