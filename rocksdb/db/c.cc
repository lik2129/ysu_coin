...
uint64_t rocksdb_perfcontext_metric(rocksdb_perfcontext_t* context,
  ...
  switch (metric) {
    ...
    case rocksdb_db_mutex_lock_ysus:
      return rep->db_mutex_lock_ysus;
    case rocksdb_db_condition_wait_ysus:
      return rep->db_condition_wait_ysus;
    case rocksdb_merge_operator_time_ysus:
      return rep->merge_operator_time_ysus;
    case rocksdb_read_index_block_ysus:
      return rep->read_index_block_ysus;
    case rocksdb_read_filter_block_ysus:
      return rep->read_filter_block_ysus;
    case rocksdb_new_table_block_iter_ysus:
      return rep->new_table_block_iter_ysus;
    case rocksdb_new_table_iterator_ysus:
      return rep->new_table_iterator_ysus;
    case rocksdb_block_seek_ysus:
      return rep->block_seek_ysus;
    case rocksdb_find_table_ysus:
      return rep->find_table_ysus;
    ...
    case rocksdb_env_new_sequential_file_ysus:
      return rep->env_new_sequential_file_ysus;
    case rocksdb_env_new_random_access_file_ysus:
      return rep->env_new_random_access_file_ysus;
    case rocksdb_env_new_writable_file_ysus:
      return rep->env_new_writable_file_ysus;
    case rocksdb_env_reuse_writable_file_ysus:
      return rep->env_reuse_writable_file_ysus;
    case rocksdb_env_new_random_rw_file_ysus:
      return rep->env_new_random_rw_file_ysus;
    case rocksdb_env_new_directory_ysus:
      return rep->env_new_directory_ysus;
    case rocksdb_env_file_exists_ysus:
      return rep->env_file_exists_ysus;
    case rocksdb_env_get_children_ysus:
      return rep->env_get_children_ysus;
    case rocksdb_env_get_children_file_attributes_ysus:
      return rep->env_get_children_file_attributes_ysus;
    case rocksdb_env_delete_file_ysus:
      return rep->env_delete_file_ysus;
    case rocksdb_env_create_dir_ysus:
      return rep->env_create_dir_ysus;
    case rocksdb_env_create_dir_if_missing_ysus:
      return rep->env_create_dir_if_missing_ysus;
    case rocksdb_env_delete_dir_ysus:
      return rep->env_delete_dir_ysus;
    case rocksdb_env_get_file_size_ysus:
      return rep->env_get_file_size_ysus;
    case rocksdb_env_get_file_modification_time_ysus:
      return rep->env_get_file_modification_time_ysus;
    case rocksdb_env_rename_file_ysus:
      return rep->env_rename_file_ysus;
    case rocksdb_env_link_file_ysus:
      return rep->env_link_file_ysus;
    case rocksdb_env_lock_file_ysus:
      return rep->env_lock_file_ysus;
    case rocksdb_env_unlock_file_ysus:
      return rep->env_unlock_file_ysus;
    case rocksdb_env_new_logger_ysus:
      return rep->env_new_logger_ysus;
    default:
      break;
  }
  return 0;
