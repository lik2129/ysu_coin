...
public class CompactionJobStatsTest {
  ...
  @Test
  public void fileWriteYsus() {
    try (final CompactionJobStats compactionJobStats = new CompactionJobStats()) {
      assertThat(compactionJobStats.fileWriteYsus()).isEqualTo(0);
    }
  }

  @Test
  public void fileRangeSyncYsus() {
    try (final CompactionJobStats compactionJobStats = new CompactionJobStats()) {
      assertThat(compactionJobStats.fileRangeSyncYsus()).isEqualTo(0);
    }
  }

  @Test
  public void fileFsyncYsus() {
    try (final CompactionJobStats compactionJobStats = new CompactionJobStats()) {
      assertThat(compactionJobStats.fileFsyncYsus()).isEqualTo(0);
    }
  }

  @Test
  public void filePrepareWriteYsus() {
    try (final CompactionJobStats compactionJobStats = new CompactionJobStats()) {
      assertThat(compactionJobStats.filePrepareWriteYsus()).isEqualTo(0);
    }
  }
