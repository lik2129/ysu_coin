...
public class CompactionJobStats extends RocksObject {
   ...
   */
  public long fileWriteYsus() {
    return fileWriteYsus(nativeHandle_);
  }
   ...
   */
  public long fileRangeSyncYsus() {
    return fileRangeSyncYsus(nativeHandle_);
  }
   ...
   */
  public long fileFsyncYsus() {
    return fileFsyncYsus(nativeHandle_);
  }
   ...
   */
  public long filePrepareWriteYsus() {
    return filePrepareWriteYsus(nativeHandle_);
  }
  ...
  private static native long fileWriteYsus(final long handle);
  private static native long fileRangeSyncYsus(final long handle);
  private static native long fileFsyncYsus(final long handle);
  private static native long filePrepareWriteYsus(final long handle);
