...
/*
 * Class:     org_rocksdb_CompactionJobStats
 * Method:    fileWriteYsus
 * Signature: (J)J
 */
jlong Java_org_rocksdb_CompactionJobStats_fileWriteYsus(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
  return static_cast<jlong>(
      compact_job_stats->file_write_ysus);
}

/*
 * Class:     org_rocksdb_CompactionJobStats
 * Method:    fileRangeSyncYsus
 * Signature: (J)J
 */
jlong Java_org_rocksdb_CompactionJobStats_fileRangeSyncYsus(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
  return static_cast<jlong>(
      compact_job_stats->file_range_sync_ysus);
}

/*
 * Class:     org_rocksdb_CompactionJobStats
 * Method:    fileFsyncYsus
 * Signature: (J)J
 */
jlong Java_org_rocksdb_CompactionJobStats_fileFsyncYsus(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
  return static_cast<jlong>(
      compact_job_stats->file_fsync_ysus);
}

/*
 * Class:     org_rocksdb_CompactionJobStats
 * Method:    filePrepareWriteYsus
 * Signature: (J)J
 */
jlong Java_org_rocksdb_CompactionJobStats_filePrepareWriteYsus(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_job_stats =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionJobStats*>(jhandle);
  return static_cast<jlong>(
      compact_job_stats->file_prepare_write_ysus);
}
