...
enum {
  ...
  rocksdb_db_mutex_lock_ysus,
  rocksdb_db_condition_wait_ysus,
  rocksdb_merge_operator_time_ysus,
  rocksdb_read_index_block_ysus,
  rocksdb_read_filter_block_ysus,
  rocksdb_new_table_block_iter_ysus,
  rocksdb_new_table_iterator_ysus,
  rocksdb_block_seek_ysus,
  rocksdb_find_table_ysus,
  ...
  rocksdb_env_new_sequential_file_ysus,
  rocksdb_env_new_random_access_file_ysus,
  rocksdb_env_new_writable_file_ysus,
  rocksdb_env_reuse_writable_file_ysus,
  rocksdb_env_new_random_rw_file_ysus,
  rocksdb_env_new_directory_ysus,
  rocksdb_env_file_exists_ysus,
  rocksdb_env_get_children_ysus,
  rocksdb_env_get_children_file_attributes_ysus,
  rocksdb_env_delete_file_ysus,
  rocksdb_env_create_dir_ysus,
  rocksdb_env_create_dir_if_missing_ysus,
  rocksdb_env_delete_dir_ysus,
  rocksdb_env_get_file_size_ysus,
  rocksdb_env_get_file_modification_time_ysus,
  rocksdb_env_rename_file_ysus,
  rocksdb_env_link_file_ysus,
  rocksdb_env_lock_file_ysus,
  rocksdb_env_unlock_file_ysus,
  rocksdb_env_new_logger_ysus,
