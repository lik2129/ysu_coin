...
inline double to_multiplier (ysu_pow_server::u128 const difficulty_a, ysu_pow_server::u128 const base_difficulty_a)
{
...
inline ysu_pow_server::u128 from_multiplier (double const multiplier_a, ysu_pow_server::u128 const base_difficulty_a)
{
