...
class generateMarkdown():
    ...
    def __init__(self, repo):
        ...
        self.mdFile.new_line(
            "## **Release** " + \
            "[{0}](https://github.com/ysucurrency/ysu-node/tree/{0})"\
                .format(repo.end))
        self.mdFile.new_line("[Full Changelog](https://github.com/ysucurrency"\
            "/ysu-node/compare/{0}...{1})".format(repo.start, repo.end))
