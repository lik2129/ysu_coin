...
ysu::rpc::rpc (boost::asio::io_context & io_ctx_a, ysu::rpc_config const & config_a, ysu::rpc_handler_interface & rpc_handler_interface_a) :
config (config_a),
acceptor (io_ctx_a),
...
void ysu::rpc::accept ()
{
	auto connection (std::make_shared<ysu::rpc_connection> (config, io_ctx, logger, rpc_handler_interface));
...
std::unique_ptr<ysu::rpc> ysu::get_rpc (boost::asio::io_context & io_ctx_a, ysu::rpc_config const & config_a, ysu::rpc_handler_interface & rpc_handler_interface_a)
{
