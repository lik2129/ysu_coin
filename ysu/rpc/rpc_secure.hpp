...
{
/**
 * Specialization of ysu::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_context & context_a, ysu::rpc_config const & config_a, ysu::rpc_handler_interface & rpc_handler_interface_a);
