...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw ysu::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (ysu::node & node_a, ysu::ipc::ipc_server & ipc_server_a, std::shared_ptr<ysu::ipc::subscriber> const & subscriber_a, ysu::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (ysu::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		ysu::ipc::ipc_config const & ipc_config;
	};
}
}
