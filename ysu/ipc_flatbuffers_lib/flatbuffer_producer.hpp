...
namespace ipc
{
	/** Produces Ysu API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			ysu::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			ysuapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (ysuapi::MessageTraits<T>::enum_value);
