...
ysu::error ysu::stat_config::deserialize_json (ysu::jsonconfig & json)
{
...
ysu::error ysu::stat_config::deserialize_toml (ysu::tomlconfig & toml)
{
...
ysu::error ysu::stat_config::serialize_toml (ysu::tomlconfig & toml) const
{
	ysu::tomlconfig sampling_l;
...
std::string ysu::stat_log_sink::tm_to_string (tm & tm)
{
...
class json_writer : public ysu::stat_log_sink
{
...
class file_writer : public ysu::stat_log_sink
{
public:
	std::ofstream log;
	std::string filename;
...
ysu::stat::stat (ysu::stat_config config) :
config (config)
{
}

std::shared_ptr<ysu::stat_entry> ysu::stat::get_entry (uint32_t key)
{
	return get_entry (key, config.interval, config.capacity);
}

std::shared_ptr<ysu::stat_entry> ysu::stat::get_entry (uint32_t key, size_t interval, size_t capacity)
{
	ysu::unique_lock<std::mutex> lock (stat_mutex);
	return get_entry_impl (key, interval, capacity);
}

std::shared_ptr<ysu::stat_entry> ysu::stat::get_entry_impl (uint32_t key, size_t interval, size_t capacity)
{
	std::shared_ptr<ysu::stat_entry> res;
	auto entry = entries.find (key);
	if (entry == entries.end ())
	{
		res = entries.emplace (key, std::make_shared<ysu::stat_entry> (capacity, interval)).first->second;
	}
	else
	{
		res = entry->second;
...
std::unique_ptr<ysu::stat_log_sink> ysu::stat::log_sink_json () const
{
	return std::make_unique<json_writer> ();
}

void ysu::stat::log_counters (stat_log_sink & sink)
{
	ysu::unique_lock<std::mutex> lock (stat_mutex);
	log_counters_impl (sink);
}

void ysu::stat::log_counters_impl (stat_log_sink & sink)
{
	sink.begin ();
...
void ysu::stat::log_samples (stat_log_sink & sink)
{
	ysu::unique_lock<std::mutex> lock (stat_mutex);
	log_samples_impl (sink);
}

void ysu::stat::log_samples_impl (stat_log_sink & sink)
{
	sink.begin ();
	if (sink.entries () >= config.log_rotation_count)
	{
...
void ysu::stat::update (uint32_t key_a, uint64_t value)
{
...
std::chrono::seconds ysu::stat::last_reset ()
{
	ysu::unique_lock<std::mutex> lock (stat_mutex);
	auto now (std::chrono::steady_clock::now ());
...
void ysu::stat::stop ()
{
	ysu::lock_guard<std::mutex> guard (stat_mutex);
	stopped = true;
}
...
std::string ysu::stat::type_to_string (uint32_t key)
{
	auto type = static_cast<stat::type> (key >> 16 & 0x000000ff);
	std::string res;
	switch (type)
	{
		case ysu::stat::type::ipc:
			res = "ipc";
			break;
		case ysu::stat::type::block:
			res = "block";
			break;
		case ysu::stat::type::bootstrap:
			res = "bootstrap";
			break;
		case ysu::stat::type::error:
			res = "error";
			break;
		case ysu::stat::type::http_callback:
			res = "http_callback";
			break;
		case ysu::stat::type::ledger:
			res = "ledger";
			break;
		case ysu::stat::type::tcp:
			res = "tcp";
			break;
		case ysu::stat::type::udp:
			res = "udp";
			break;
		case ysu::stat::type::peering:
			res = "peering";
			break;
		case ysu::stat::type::rollback:
			res = "rollback";
			break;
		case ysu::stat::type::traffic_udp:
			res = "traffic_udp";
			break;
		case ysu::stat::type::traffic_tcp:
			res = "traffic_tcp";
			break;
		case ysu::stat::type::vote:
			res = "vote";
			break;
		case ysu::stat::type::election:
			res = "election";
			break;
		case ysu::stat::type::message:
			res = "message";
			break;
		case ysu::stat::type::confirmation_observer:
			res = "observer";
			break;
		case ysu::stat::type::confirmation_height:
			res = "confirmation_height";
			break;
		case ysu::stat::type::drop:
			res = "drop";
			break;
		case ysu::stat::type::aggregator:
			res = "aggregator";
			break;
		case ysu::stat::type::requests:
			res = "requests";
			break;
		case ysu::stat::type::filter:
			res = "filter";
			break;
		case ysu::stat::type::telemetry:
			res = "telemetry";
			break;
		case ysu::stat::type::vote_generator:
			res = "vote_generator";
			break;
	}
	return res;
...
std::string ysu::stat::detail_to_string (uint32_t key)
{
	auto detail = static_cast<stat::detail> (key >> 8 & 0x000000ff);
	std::string res;
	switch (detail)
	{
		case ysu::stat::detail::all:
			res = "all";
			break;
		case ysu::stat::detail::bad_sender:
			res = "bad_sender";
			break;
		case ysu::stat::detail::bulk_pull:
			res = "bulk_pull";
			break;
		case ysu::stat::detail::bulk_pull_account:
			res = "bulk_pull_account";
			break;
		case ysu::stat::detail::bulk_pull_deserialize_receive_block:
			res = "bulk_pull_deserialize_receive_block";
			break;
		case ysu::stat::detail::bulk_pull_error_starting_request:
			res = "bulk_pull_error_starting_request";
			break;
		case ysu::stat::detail::bulk_pull_failed_account:
			res = "bulk_pull_failed_account";
			break;
		case ysu::stat::detail::bulk_pull_receive_block_failure:
			res = "bulk_pull_receive_block_failure";
			break;
		case ysu::stat::detail::bulk_pull_request_failure:
			res = "bulk_pull_request_failure";
			break;
		case ysu::stat::detail::bulk_push:
			res = "bulk_push";
			break;
		case ysu::stat::detail::active_quorum:
			res = "observer_confirmation_active_quorum";
			break;
		case ysu::stat::detail::active_conf_height:
			res = "observer_confirmation_active_conf_height";
			break;
		case ysu::stat::detail::inactive_conf_height:
			res = "observer_confirmation_inactive";
			break;
		case ysu::stat::detail::error_socket_close:
			res = "error_socket_close";
			break;
		case ysu::stat::detail::change:
			res = "change";
			break;
		case ysu::stat::detail::confirm_ack:
			res = "confirm_ack";
			break;
		case ysu::stat::detail::node_id_handshake:
			res = "node_id_handshake";
			break;
		case ysu::stat::detail::confirm_req:
			res = "confirm_req";
			break;
		case ysu::stat::detail::fork:
			res = "fork";
			break;
		case ysu::stat::detail::old:
			res = "old";
			break;
		case ysu::stat::detail::gap_previous:
			res = "gap_previous";
			break;
		case ysu::stat::detail::gap_source:
			res = "gap_source";
			break;
		case ysu::stat::detail::frontier_confirmation_failed:
			res = "frontier_confirmation_failed";
			break;
		case ysu::stat::detail::frontier_confirmation_successful:
			res = "frontier_confirmation_successful";
			break;
		case ysu::stat::detail::frontier_req:
			res = "frontier_req";
			break;
		case ysu::stat::detail::handshake:
			res = "handshake";
			break;
		case ysu::stat::detail::http_callback:
			res = "http_callback";
			break;
		case ysu::stat::detail::initiate:
			res = "initiate";
			break;
		case ysu::stat::detail::initiate_lazy:
			res = "initiate_lazy";
			break;
		case ysu::stat::detail::initiate_wallet_lazy:
			res = "initiate_wallet_lazy";
			break;
		case ysu::stat::detail::insufficient_work:
			res = "insufficient_work";
			break;
		case ysu::stat::detail::invocations:
			res = "invocations";
			break;
		case ysu::stat::detail::keepalive:
			res = "keepalive";
			break;
		case ysu::stat::detail::open:
			res = "open";
			break;
		case ysu::stat::detail::publish:
			res = "publish";
			break;
		case ysu::stat::detail::receive:
			res = "receive";
			break;
		case ysu::stat::detail::republish_vote:
			res = "republish_vote";
			break;
		case ysu::stat::detail::send:
			res = "send";
			break;
		case ysu::stat::detail::telemetry_req:
			res = "telemetry_req";
			break;
		case ysu::stat::detail::telemetry_ack:
			res = "telemetry_ack";
			break;
		case ysu::stat::detail::state_block:
			res = "state_block";
			break;
		case ysu::stat::detail::epoch_block:
			res = "epoch_block";
			break;
		case ysu::stat::detail::vote_valid:
			res = "vote_valid";
			break;
		case ysu::stat::detail::vote_replay:
			res = "vote_replay";
			break;
		case ysu::stat::detail::vote_indeterminate:
			res = "vote_indeterminate";
			break;
		case ysu::stat::detail::vote_invalid:
			res = "vote_invalid";
			break;
		case ysu::stat::detail::vote_overflow:
			res = "vote_overflow";
			break;
		case ysu::stat::detail::vote_new:
			res = "vote_new";
			break;
		case ysu::stat::detail::vote_cached:
			res = "vote_cached";
			break;
		case ysu::stat::detail::late_block:
			res = "late_block";
			break;
		case ysu::stat::detail::late_block_seconds:
			res = "late_block_seconds";
			break;
		case ysu::stat::detail::election_non_priority:
			res = "election_non_priority";
			break;
		case ysu::stat::detail::election_priority:
			res = "election_priority";
			break;
		case ysu::stat::detail::election_block_conflict:
			res = "election_block_conflict";
			break;
		case ysu::stat::detail::election_difficulty_update:
			res = "election_difficulty_update";
			break;
		case ysu::stat::detail::election_drop:
			res = "election_drop";
			break;
		case ysu::stat::detail::election_restart:
			res = "election_restart";
			break;
		case ysu::stat::detail::blocking:
			res = "blocking";
			break;
		case ysu::stat::detail::overflow:
			res = "overflow";
			break;
		case ysu::stat::detail::tcp_accept_success:
			res = "accept_success";
			break;
		case ysu::stat::detail::tcp_accept_failure:
			res = "accept_failure";
			break;
		case ysu::stat::detail::tcp_write_drop:
			res = "tcp_write_drop";
			break;
		case ysu::stat::detail::tcp_write_no_socket_drop:
			res = "tcp_write_no_socket_drop";
			break;
		case ysu::stat::detail::tcp_excluded:
			res = "tcp_excluded";
			break;
		case ysu::stat::detail::unreachable_host:
			res = "unreachable_host";
			break;
		case ysu::stat::detail::invalid_header:
			res = "invalid_header";
			break;
		case ysu::stat::detail::invalid_message_type:
			res = "invalid_message_type";
			break;
		case ysu::stat::detail::invalid_keepalive_message:
			res = "invalid_keepalive_message";
			break;
		case ysu::stat::detail::invalid_publish_message:
			res = "invalid_publish_message";
			break;
		case ysu::stat::detail::invalid_confirm_req_message:
			res = "invalid_confirm_req_message";
			break;
		case ysu::stat::detail::invalid_confirm_ack_message:
			res = "invalid_confirm_ack_message";
			break;
		case ysu::stat::detail::invalid_node_id_handshake_message:
			res = "invalid_node_id_handshake_message";
			break;
		case ysu::stat::detail::invalid_telemetry_req_message:
			res = "invalid_telemetry_req_message";
			break;
		case ysu::stat::detail::invalid_telemetry_ack_message:
			res = "invalid_telemetry_ack_message";
			break;
		case ysu::stat::detail::outdated_version:
			res = "outdated_version";
			break;
		case ysu::stat::detail::blocks_confirmed:
			res = "blocks_confirmed";
			break;
		case ysu::stat::detail::blocks_confirmed_unbounded:
			res = "blocks_confirmed_unbounded";
			break;
		case ysu::stat::detail::blocks_confirmed_bounded:
			res = "blocks_confirmed_bounded";
			break;
		case ysu::stat::detail::aggregator_accepted:
			res = "aggregator_accepted";
			break;
		case ysu::stat::detail::aggregator_dropped:
			res = "aggregator_dropped";
			break;
		case ysu::stat::detail::requests_cached_hashes:
			res = "requests_cached_hashes";
			break;
		case ysu::stat::detail::requests_generated_hashes:
			res = "requests_generated_hashes";
			break;
		case ysu::stat::detail::requests_cached_votes:
			res = "requests_cached_votes";
			break;
		case ysu::stat::detail::requests_generated_votes:
			res = "requests_generated_votes";
			break;
		case ysu::stat::detail::requests_cached_late_hashes:
			res = "requests_cached_late_hashes";
			break;
		case ysu::stat::detail::requests_cached_late_votes:
			res = "requests_cached_late_votes";
			break;
		case ysu::stat::detail::requests_cannot_vote:
			res = "requests_cannot_vote";
			break;
		case ysu::stat::detail::requests_unknown:
			res = "requests_unknown";
			break;
		case ysu::stat::detail::duplicate_publish:
			res = "duplicate_publish";
			break;
		case ysu::stat::detail::different_genesis_hash:
			res = "different_genesis_hash";
			break;
		case ysu::stat::detail::invalid_signature:
			res = "invalid_signature";
			break;
		case ysu::stat::detail::node_id_mismatch:
			res = "node_id_mismatch";
			break;
		case ysu::stat::detail::request_within_protection_cache_zone:
			res = "request_within_protection_cache_zone";
			break;
		case ysu::stat::detail::no_response_received:
			res = "no_response_received";
			break;
		case ysu::stat::detail::unsolicited_telemetry_ack:
			res = "unsolicited_telemetry_ack";
			break;
		case ysu::stat::detail::failed_send_telemetry_req:
			res = "failed_send_telemetry_req";
			break;
		case ysu::stat::detail::generator_broadcasts:
			res = "generator_broadcasts";
			break;
		case ysu::stat::detail::generator_replies:
			res = "generator_replies";
			break;
		case ysu::stat::detail::generator_replies_discarded:
...
std::string ysu::stat::dir_to_string (uint32_t key)
{
	auto dir = static_cast<stat::dir> (key & 0x000000ff);
	std::string res;
	switch (dir)
	{
		case ysu::stat::dir::in:
			res = "in";
			break;
		case ysu::stat::dir::out:
			res = "out";
			break;
	}
	return res;
...
ysu::stat_datapoint::stat_datapoint (stat_datapoint const & other_a)
{
	ysu::lock_guard<std::mutex> lock (other_a.datapoint_mutex);
	value = other_a.value;
	timestamp = other_a.timestamp;
}

ysu::stat_datapoint & ysu::stat_datapoint::operator= (stat_datapoint const & other_a)
{
	ysu::lock_guard<std::mutex> lock (other_a.datapoint_mutex);
	value = other_a.value;
	timestamp = other_a.timestamp;
...
uint64_t ysu::stat_datapoint::get_value () const
{
	ysu::lock_guard<std::mutex> lock (datapoint_mutex);
	return value;
}

void ysu::stat_datapoint::set_value (uint64_t value_a)
{
	ysu::lock_guard<std::mutex> lock (datapoint_mutex);
	value = value_a;
}

std::chrono::system_clock::time_point ysu::stat_datapoint::get_timestamp () const
{
	ysu::lock_guard<std::mutex> lock (datapoint_mutex);
	return timestamp;
}

void ysu::stat_datapoint::set_timestamp (std::chrono::system_clock::time_point timestamp_a)
{
	ysu::lock_guard<std::mutex> lock (datapoint_mutex);
...
void ysu::stat_datapoint::add (uint64_t addend, bool update_timestamp)
{
	ysu::lock_guard<std::mutex> lock (datapoint_mutex);
	value += addend;
	if (update_timestamp)
