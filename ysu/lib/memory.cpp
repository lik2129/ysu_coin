...
bool ysu::get_use_memory_pools ()
{
	return use_memory_pools;
}

/** This has no effect on Mac */
void ysu::set_use_memory_pools (bool use_memory_pools_a)
{
#ifndef __APPLE__
...
ysu::cleanup_guard::cleanup_guard (std::vector<std::function<void()>> const & cleanup_funcs_a) :
