...
std::vector<std::string> ysu::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & ysu::operator>> (std::istream & is, ysu::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{
