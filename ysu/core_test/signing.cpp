...
{
	ysu::signature_checker checker (0);
	ysu::signature_check_set check = { 0, nullptr, nullptr, nullptr, nullptr, nullptr };
...
{
	ysu::signature_checker checker (4);
	...
	auto signature_checker_work_func = [&checker]() {
		...
		ysu::state_block invalid_block (key.pub, 0, key.pub, 0, 0, key.prv, key.pub, 0);
		...
		std::vector<ysu::signature_check_set> signature_checker_sets;
...
TEST (signature_checker, boundary_checks)
{
	...
	ysu::signature_checker checker (1);
